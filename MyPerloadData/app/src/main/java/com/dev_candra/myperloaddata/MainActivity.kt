...
import com.dev_candra.myperloaddata.databinding.ActivityMainBinding
import com.dev_candra.myperloaddata.servis.DataManagerService
import com.dev_candra.myperloaddata.servis.DataManagerService.Companion.CANCEL_MESSAGE
import com.dev_candra.myperloaddata.servis.DataManagerService.Companion.FAILED_MESSAGE
import com.dev_candra.myperloaddata.servis.DataManagerService.Companion.PREPARATION_MESSAGE
import com.dev_candra.myperloaddata.servis.DataManagerService.Companion.SUCCESS_MESSAGE
import com.dev_candra.myperloaddata.servis.DataManagerService.Companion.UPDATE_MESSAGE
...
class MainActivity : AppCompatActivity(), HandlerCallback {
    ...
    */
    ...
    /*
    Ketika kondisi dari handleMessage sesuai, maka WeakReference akan mengirim nilai balikan sesuai dengan kondisi yang diterima melalui HandlerCallback dan di dalam kelas MainActivity Anda bisa memberi aksi pada kondisi tersebut. Seperti ketika berhasil memuat data, maka akan berpindah ke kelas MahasiswaActivity.
     */
...
/*
Bagaimana pemeriksaan itu terjadi? Mari kita bedah MainActivity-nya. Di dalam MainActivity ada kode LoadDataAsync yang digunakan untuk melakukan proses insert data ke dalam database. Mari perhatikan kodenya:
...
Kode ini akan memeriksa nilai pada appPreference, apakah data awal sudah tersimpan apa belum.
