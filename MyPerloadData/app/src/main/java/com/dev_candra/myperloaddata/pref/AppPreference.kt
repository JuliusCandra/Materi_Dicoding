package com.dev_candra.myperloaddata.pref
...
Fungsi setFirstRun digunakan untuk mengganti nilai dengan kata kunci string dari app_first_run. Metode ini akan dipanggil setelah proses insert ke dalam database berhasil.
