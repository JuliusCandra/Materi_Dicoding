...
import com.dev_candra.replyactivity.NotificationService.Companion.CHANNEL_ID
import com.dev_candra.replyactivity.NotificationService.Companion.CHANNEL_NAME
import com.dev_candra.replyactivity.NotificationService.Companion.REPLY_ACTION
...
class NotificationBroadcastReceiver : BroadcastReceiver() {
    ...
    companion object {
        ...
        /*
        Untuk membaca inputan dari direct message kita bisa menggunakan remoteinput dengan kode seperti di atas. Kemudian untuk menerimanya, kita menggunakan method onReceivedi kelas NotificationBroadcastReceiver.
         */
    ...
    /*
    Anda tak perlu menambahkan remote input secara terus menerus. Anda hanya perlu memperbarui notifikasi dengan notification manager seperti kode di atas.
     */
